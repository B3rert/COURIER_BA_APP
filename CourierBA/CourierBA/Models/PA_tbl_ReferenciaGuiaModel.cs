...
{
    // PA_tbl_ReferenciaGuia myDeserializedClass = JsonConvert.DeserializeObject<PA_tbl_ReferenciaGuia>(myJsonResponse); 


    public class PA_tbl_ReferenciaGuiaModel
    {
        ...
        public object Referencia_Padre { get; set; }
    ...
    public class PA_tbl_ReferenciaGuia
    {
        public List<PA_tbl_ReferenciaGuiaModel> Table { get; set; }
    }
}
